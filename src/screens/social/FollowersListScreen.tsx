...
type FollowersRouteProp = RouteProp<SocialStackParamList, 'Followers'>;
type FollowersNavigationProp = StackNavigationProp<SocialStackParamList, 'Followers'>;
  ...
  useEffect(() => {
    if (searchQuery.trim() === '') {
      ...
      setFilteredFollowers(
        followers.filter((user) => user.name.toLowerCase().includes(query))
      );
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        contentContainerStyle={filteredFollowers.length === 0 ? styles.emptyList : undefined}
      />
    </View>
  );
};
